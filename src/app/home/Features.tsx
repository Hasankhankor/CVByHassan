...
const FEATURES = [
  ...
  {
    src: featureUSSrc,
    title: "Pakistan  Best Practices",
    text: "OpenResume has built-in best practices for the Pakistan job market and works well with top ATS platforms such as Greenhouse and Lever",
  },
  {
